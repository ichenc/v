parcelRequire = function(e, r, t, n) {
	...
	"Bb20": [function(require, module, exports) {
		...
		function e() {
			var e = ["一旦你尝试过天空的味道<br>你就会永远向上仰望","时间是件无价的易耗品<br>不管你愿不愿意，它总是被消耗着。", "爱若执炬迎风，炽烈而哀恸<br>诸般滋味皆在其中", "一望无际的迷雾中<br>有人在寻找光明!",
					"你所热爱的<br>就是你的生活", "鹤汀凫渚，穷岛屿之萦回<br>桂殿兰宫，即冈峦之体势", "我和你，可以做朋友吗？", "平凡的日常正奇迹的发生着", "其实美丽的故事都是没有结局的<br>只因为它没有结局所以才会美丽",
					"一个人的自身越是丰富<br>就越难以忍受世俗常规的安排", "任尘世繁华<br>唯有守护你的一切<br>才是我此生唯一的使命", "这里有着无论何时永远不会消失<br>美丽的无穷光辉<br>满天的星星等候着大家的到来",
					"最终，森林会记住一切……"
				],
				i = o(0, e.length - 1);
			t("#slogan").html(e[i])
